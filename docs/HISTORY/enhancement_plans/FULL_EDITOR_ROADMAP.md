...
2. **Map Field Byte Offsets**
   - Current: We have maintained field notes in [`../../DATA_FORMATS.md`](../../DATA_FORMATS.md)
...
**Based on current field notes** ([`../../DATA_FORMATS.md`](../../DATA_FORMATS.md)):
...
### ✅ Known Information
- Field schema summary from [`../../DATA_FORMATS.md`](../../DATA_FORMATS.md)
