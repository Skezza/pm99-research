...
- Remaining archive notes: [../../archive/TEAM_FIELD_STRUCTURE_GUESS.md](../../archive/TEAM_FIELD_STRUCTURE_GUESS.md)

Relationship to other canonical docs
- Formats and byte rules: [DATA_FORMATS.md](../../DATA_FORMATS.md)
- Detailed mapping supplement: [PLAYER_FIELDS.md](../../REFERENCE/PLAYER_FIELDS.md)
- Getting started and workflows: [GETTING_STARTED.md](../../GETTING_STARTED.md)
...
Versioning
- Track user-visible documentation changes in git history; there is no maintained standalone changelog.
