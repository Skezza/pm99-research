...
- Commands: [cli.cmd_info()](../pm99_editor/cli.py:74), [cli.cmd_list()](../pm99_editor/cli.py:10), [cli.cmd_search()](../pm99_editor/cli.py:22), [cli.cmd_rename()](../pm99_editor/cli.py:38)
...
- The writer creates backups with [file_writer.create_backup()](../pm99_editor/file_writer.py:17)
- In-place record writes adjust directory offsets via [file_writer.write_fdi_record()](../pm99_editor/file_writer.py:102)
- Parsing and writing are conservative by design:
  - Parser: [PlayerRecord.from_bytes()](../pm99_editor/models.py:63)
  - Serializer: [PlayerRecord.to_bytes()](../pm99_editor/models.py:281)
  - I/O wrapper: [FDIFile.load()](../pm99_editor/io.py:31), [FDIFile.save()](../pm99_editor/io.py:269)

3) Core mental model (2 minutes)
- File format header and directory are represented by:
  - [FDIHeader.from_bytes()](../pm99_editor/models.py:389) / [FDIHeader.to_bytes()](../pm99_editor/models.py:412)
  - [DirectoryEntry.from_bytes()](../pm99_editor/models.py:434) / [DirectoryEntry.to_bytes()](../pm99_editor/models.py:442)
- Records are decoded from sections using XOR-0x61; see:
  - Section scanning and decoding: [FDIFile._iter_records()](../pm99_editor/io.py:63)
- Player record parsing is dynamic:
  - Names parsed from early bytes, then a name-end marker 'aaaa' (0x61*4) is detected by [PlayerRecord._find_name_end()](../pm99_editor/models.py:261)
...
- Most unknown bytes are preserved verbatim during writes by basing serialization on the original [PlayerRecord.raw_data](../pm99_editor/models.py:59)
...
```
Helpful helpers: [FDIFile.list_players()](../pm99_editor/io.py:338), [FDIFile.find_by_name()](../pm99_editor/io.py:229), [FDIFile.find_by_id()](../pm99_editor/io.py:211)

Replace text in decoded payloads (advanced)
- Use [file_writer.replace_text_in_decoded()](../pm99_editor/file_writer.py:32) to prepare a decoded buffer
- Then persist the new payload with [file_writer.write_fdi_record()](../pm99_editor/file_writer.py:102)
...
7) Troubleshooting
- “Player not found” — list first: `python -m pm99_editor list DBDAT/JUG98030.FDI --limit 50` and copy exact casing
- “Length mismatch/corruption risk” — keep names same length or use padding strategies in [file_writer.replace_text_in_decoded()](../pm99_editor/file_writer.py:32), then persist through [file_writer.write_fdi_record()](../pm99_editor/file_writer.py:102)
- Restoring files — use the `.backup` created by [file_writer.create_backup()](../pm99_editor/file_writer.py:17)
...
- Advanced write paths should be driven through record‑level serialization [PlayerRecord.to_bytes()](../pm99_editor/models.py:281) + safe write [file_writer.write_fdi_record()](../pm99_editor/file_writer.py:102)
