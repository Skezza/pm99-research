...
Implements the encode_data_xor61/decode_data_xor61 routines from MANAGPRE.EXE.
"""
...
def decode_entry(data: bytes, offset: int) -> Tuple[bytes, int]:
    ...
    Reproduces MANAGPRE.EXE.decode_data_xor61() at 0x00677e30.
    ...
    # XOR decode (byte-by-byte, matches binary's optimized 32-bit logic)
